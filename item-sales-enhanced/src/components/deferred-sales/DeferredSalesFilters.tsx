...
interface DeferredSalesFiltersProps {
  onReportTypeChange?: (reportType: string) => void;
}

export function DeferredSalesFilters({ onReportTypeChange }: DeferredSalesFiltersProps) {
  ...
  const handleFilterChange = (filterLabel: string, newValue: string) => {
    ...
    // Notify parent component about report type change
    if (filterLabel === 'Report type' && onReportTypeChange) {
      onReportTypeChange(newValue);
    }
  };
    ...
    <div className="bg-white border-b border-gray-200 px-6 py-3">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-500">Deferred sales & 15 others</span>
